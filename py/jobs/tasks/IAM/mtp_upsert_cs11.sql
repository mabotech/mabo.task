-- Function: mtp_upsert_cs11(json)

-- DROP FUNCTION mtp_upsert_cs11(json);

CREATE OR REPLACE FUNCTION mtp_upsert_cs11(i_json json)
  RETURNS json AS
$BODY$
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION mtp_upsert_cs11(json)
  OWNER TO mabotech;
