-- Function: mtp_upsert_cs12(json)

-- DROP FUNCTION mtp_upsert_cs12(json);

CREATE OR REPLACE FUNCTION mtp_upsert_cs12(i_json json)
  RETURNS json AS
$BODY$
...
sql = "select id from #{v_table} where #{v_pkey} = '#{v_id}'"
...
try
    ...
    v_sql = "select mtp_state_update3 as vdata from mtp_state_update3(#{v_id})"
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION mtp_upsert_cs12(json)
  OWNER TO mabotech;
